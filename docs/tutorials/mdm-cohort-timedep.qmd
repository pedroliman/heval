...
The base case reproduces the published table. Age-varying mortality lowers life expectancy, so every strategy accrues fewer quality-adjusted life-years than in the time-independent model. Strategy A is dominated; Strategy B and Strategy AB stay on the frontier.
