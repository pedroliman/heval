...
check = MicrosimModel(
    states=STATES,
    transition_probabilities=lambda params, state, attrs, rng: P[state],
    state_costs_and_utilities=lambda params, state, attrs: (cost_vec[state], eff_vec[state]),
