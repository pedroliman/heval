...
`one_way` varies a single parameter across the listed values, holding the rest at base. Here the incremental net monetary benefit of Intervention AB over standard of care falls as the treatment-B cost rises, crossing zero near its base value.
