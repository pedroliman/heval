...
def microsim(n, var):
    return MicrosimModel(
        ...
        state_costs_and_utilities=state_costs_and_utilities, population=make_pop(var),
...
hist = MicrosimModel(
    ...
    state_costs_and_utilities=state_costs_and_utilities, population=make_pop(0.5),
