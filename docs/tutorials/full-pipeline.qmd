...
The [engines](../concepts/engines.qmd) concept page describes the model types `run_psa` can run. Next: the [value of information](voi.qmd) tutorial takes outcomes like these through the expected value of perfect, partial perfect, and sample information, checking each against a closed form.
