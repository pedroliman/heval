...
The [engines](../concepts/engines.qmd) concept page describes the model types `run_psa` can run. Next: the [value of information](voi.qmd) tutorial takes the cohort state-transition model from the [cohort tutorial](mdm-cohort.qmd) through the expected value of perfect, partial perfect, and sample information.
