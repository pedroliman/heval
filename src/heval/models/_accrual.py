...
from heval.models.outcomes import ITERATION_LEVEL, STRATEGY_LEVEL
...
def accrue(
    ...
    *,
    ...
    Example:
        >>> import numpy as np
        >>> from heval.models._accrual import accrue
...
def integrate_flow(
    ...
    Example:
        >>> from heval.models._accrual import integrate_flow
...
def aggregate(
    ...
    Example:
        >>> import numpy as np
        >>> from heval.models._accrual import aggregate
        >>> row = aggregate(
